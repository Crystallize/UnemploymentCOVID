...
peri_EmFu_FuEm_ratio <-0.39
peri_EmFu_FuEm_damp <-100
peri_EmUn_UnEm_ratio <-0.041
peri_EmUn_UnEm_damp <- 100


post_FuEm_FuUn_ratio <- 0.5
post_FuEm_FuUn_damp <- 10
post_EmUn_UnEm_ratio <- 0.041
       ...
       ## Print out some user feeback to help them keep track of progress.
        ...
        theResult <-
                doSim(inits,
                      ...
                      theStart,
                      endFur,
                      peri_EmFu_FuEm_ratio,
                      peri_EmFu_FuEm_damp,
                      peri_EmUn_UnEm_ratio,
                      peri_EmUn_UnEm_damp,
                      post_FuEm_FuUn_ratio,
                      post_FuEm_FuUn_damp,
                      post_EmUn_UnEm_ratio,
                      post_EmUn_UnEm_damp
                )
...
setwd(root)
write.csv(theResult_Em,"theResult_Em.csv")
write.csv(theResult_Fu,"theResult_Fu.csv")
write.csv(theResult_Un,"theResult_Un.csv")
...
operi_EmFu_FuEm_ratio<- theParamsOrdered[1,"peri_EmFu_FuEm_ratio"]
operi_EmFu_FuEm_damp<- theParamsOrdered[1,"peri_EmFu_FuEm_damp"]
operi_EmUn_UnEm_ratio<- theParamsOrdered[1,"peri_EmUn_UnEm_ratio"]
operi_EmUn_UnEm_damp<- theParamsOrdered[1,"peri_EmUn_UnEm_damp"]
opost_FuEm_FuUn_ratio<- theParamsOrdered[1,"post_FuEm_FuUn_ratio"]
opost_FuEm_FuUn_damp<- theParamsOrdered[1,"post_FuEm_FuUn_damp"]
opost_EmUn_UnEm_ratio<- theParamsOrdered[1,"post_EmUn_UnEm_ratio"]
opost_EmUn_UnEm_damp<- theParamsOrdered[1,"post_EmUn_UnEm_damp"]
