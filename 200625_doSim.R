        ...
        for (i in 1:(simTime-1)){
                ...
                for (j in 1:fidelity){
                        ...
                        if (i<endFur){
                                ...
                                Em_Fu <- (Emz*(peri_EmFu_FuEm_ratio/peri_EmFu_FuEm_damp)) / fidelity
                                Em_Un <- (Emz*(peri_EmUn_UnEm_ratio/peri_EmUn_UnEm_damp)) / fidelity
                                Un_Em <- (Unz*(1/peri_EmUn_UnEm_damp)) / fidelity
                                Fu_Em <- (Fuz*(1/peri_EmFu_FuEm_damp)) / fidelity
                                Fu_Un <- 0
                                Um_Fu <- 0
                                ...
                                ## First calculate compartment transfers.
                                Em_Fu <- 0
                                Em_Un <- (Emz*(post_EmUn_UnEm_ratio/post_EmUn_UnEm_damp)) / fidelity
